...
const AllCharacter =({match}) =>(
  ...
  <ul>
  <li>
<Link to={`${match.url}/Char1`}>
Char1</Link>
</li>
<li>
<Link to={`${match.url}/Char2`}>
Char2</Link>
</li><li>
<Link to={`${match.url}/Char3`}>Char3</Link></li></ul>
...
const CurrentBattle =() =>(
<div><h3>CurrentBattle displayed here</h3></div> )
...
<li><Link to='/NewChar'>Create Character</Link></li>
<li><Link to='/AllChar'>All Characters</Link></li>
<li><Link to='/CurBattle'>Show Current Battle</Link></li>
<Route exact path ='/' component={Home} />
<Route exact path ='/NewChar' render={() => <CreateCharacter content={this.state.message} />} />
<Route exact path ='/AllChar' component={AllCharacter} />
<Route exact path ='/CurBattle' component={CurrentBattle} />
        </div></Router>
         <h2>{this.state.message}</h2> 
         <h1>{charNames.map(x=><AllCharacters ListMessage={x} key={x.id}/>)}</h1>
      </div>
    );
  }
}
